...
export function VoiceContextDock({ roomName, participantCount, microphoneOn, cameraOn, screenSharing, audioInputs, selectedAudioInput, onAudioInputChange, gateSensitivity, onGateSensitivityChange, micLevel = 0, onToggleMic, onToggleCamera, onShareScreen, onOpenFocus, onLeave }: VoiceContextDockProps) {
